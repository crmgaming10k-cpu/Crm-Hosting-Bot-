...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    inline_keyboard = [[InlineKeyboardButton("📢 Updates Channel", url="https://t.me/gurujialllink")]]
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "𝐔𝐏𝐋𝐎𝐀𝐃 𝐅𝐈𝐋𝐄𝐒 👾":
        ...
        await update.message.reply_text("⚡ Bot latency: 0.01s")
        ...
        await update.message.reply_text("📞 Contact: @L0RD_DANZO")
